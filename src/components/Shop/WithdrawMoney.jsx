            ...
            {paymentMethod ? (
              <div>
                ...
                <form onSubmit={handleSubmit}>
                  <div>
                    <label>
                      Bank Name <span className="text-green-700">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                  ...
                  <div className="pt-2">
                    <label>
                      Bank Country <span className="text-green-700">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                  ...
                  <div className="pt-2">
                    <label>
                      Bank Swift Code <span className="text-green-700">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                  ...
                  <div className="pt-2">
                    <label>
                      Bank Holder Name <span className="text-green-700">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
                  ...
                  <div className="pt-2">
                    <label>
                      Bank Address <span className="text-green-700">*</span>
                    </label>
                    <input
                      type="text"
                      name=""
              ...
              <>
                ...
                {seller && seller?.withdrawMethod ? (
                  <div>
                    ...
                    <br />
                    <h4>Available Balance: {availableBalance} RWF</h4>
                    <br />
