...
const Cart = ({ setOpenCart }) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10">
      ...
      <div className="fixed top-0 right-0 h-full w-[100%] 800px:w-[25%] bg-white flex flex-col overflow-y-scroll justify-between shadow-sm">
        {cart && cart.length === 0 ? (
          ...
          <>
            ...
            <div className="px-5 mb-3">
              ...
              <Link to="/checkout">
                <div
                  className={`h-[45px] flex items-center justify-center w-[100%] bg-[#29625d] rounded-[5px]`}
                >
