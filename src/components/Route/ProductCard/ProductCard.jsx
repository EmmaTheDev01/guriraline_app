...
const ProductCard = ({ data, isEvent }) => {
  ...
  return (
    <>
      <div className="w-[300px] h-[370px] sm:h-[320px] md:h-[350px] bg-white rounded-lg shadow-sm p-3 relative cursor-pointer">
        ...
        >
          <img
            ...
            alt=""
            className="w-full h-[200px] sm:h-[150px] md:h-[160px] object-cover"
          />
        </Link>
