const styles = {
    ...
    shop_name:"pt-3 text-[15px] text-green-900 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#fed592]",
    button: 'w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#29625d] flex items-center justify-center cursor-pointer",
