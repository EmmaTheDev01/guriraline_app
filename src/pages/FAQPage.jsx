      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 5 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                you've ordered, you can return them for a refund within 14 days
                of delivery.
              </p>
            </div>
          )}
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within Rwanda.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept visa,mastercard, MTN Momo, payment method also we have
